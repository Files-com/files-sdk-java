...
* `workspace_id` / `workspaceId`  (int64): Workspace ID for this API Key. `0` means the default workspace.
...
* `workspace_id` (Long): Workspace ID for this API Key. `0` means the default workspace.
