...
```
ListIterator<Export> history = History.listForFileCreateExport(
    Long path, 
    HashMap<String, Object> parameters = null,
    HashMap<String, Object> options = null
)
...
```
ListIterator<Export> history = History.listForFolderCreateExport(
    Long path, 
    HashMap<String, Object> parameters = null,
    HashMap<String, Object> options = null
)
...
```
ListIterator<Export> history = History.listForUserCreateExport(
    Long user_id, 
    HashMap<String, Object> parameters = null,
    HashMap<String, Object> options = null
)
...
```
ListIterator<Export> history = History.listLoginsCreateExport(
...
```
ListIterator<Export> history = History.listCreateExport(
