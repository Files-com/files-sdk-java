...
public class BandwidthSnapshot {
  ...
  */
  public static BandwidthSnapshot list( HashMap<String, Object> parameters) {
    return list(parameters, null);
  }


  // TODO: Use types for path_and_primary_params
  public static BandwidthSnapshot list( HashMap<String, Object> parameters, HashMap<String, Object> options) {
    ...
    // TODO: Send request
    return (BandwidthSnapshot) null;
  }

  public static BandwidthSnapshot all(HashMap<String, Object> parameters, HashMap<String, Object> options) {
